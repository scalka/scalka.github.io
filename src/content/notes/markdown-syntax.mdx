...
To link another note use [See my Output post](/notes/output/) for using relative URLs. You can also link to specifiv URL [See my Output post](/notes/output/).
...
<div class="gallery content-gallery">
  <img
    ...
    src="/images/notes/jesmonite-example.jpg"
    alt="Examples Jesmonite color combinations and marbling effect"
  />
  <img
    class="responsive-image"
    src="/images/notes/jesmonite-result.jpeg"
