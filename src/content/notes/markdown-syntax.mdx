...
To link another note use [See my Output post](/notes/output/) for using relative URLs. You can also link to specific URLs like [See my Output post](/notes/output/).
